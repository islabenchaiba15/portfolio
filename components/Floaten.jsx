...
export const DockDemo = () => {
  ...
  return (
    <div className="fixed z-30 bottom-0 flex items-center w-full mx-auto rounded-lg bg-transparent">
      <TooltipProvider>
        <Dock direction="middle" className="bg-background border border-border h-16">
